...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var param="?busCode="+busCode+"&active_code="+activeCode+"&send_type=6&send_ms="+encodeURI(sendMs);
		$.ajax({
		type: "post",
...
<body>
	 <div class="down_left" style="height:340px;" id="down_left_id">
		...
		<div class="list_btn" >
			...
			<li ><img src="images/zt_b.png" onclick="loadsmzt('s');" style="cursor:pointer;"/></li>
